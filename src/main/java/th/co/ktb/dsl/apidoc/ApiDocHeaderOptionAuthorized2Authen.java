...
@ApiImplicitParams({
	@ApiImplicitParam(name = "Authorization", value = "JWT Access Token", required = false, 
	...
	@ApiImplicitParam(name = "Verify-Token-Action", value = "Token สำหรับตรวจสอบเพื่อดำเนินการบริการบางประเภท", required = false, 
			allowEmptyValue = false, paramType = "header", dataTypeClass = String.class, 
			example = "Token <action_token>"),
})
public @interface ApiDocHeaderOptionAuthorized2Authen {}
